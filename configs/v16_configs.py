...
CONFIGS = [
    ...
    dict(
        key="gridleft",
        name="B · Four On Top — Slid Left",
        letter="B",
        short="left 2×3",
        tagline="The straight 2x3 grid slid west; the east service lane widens",
        rot90=False,
        tables=[("T0L", 93.0, 233.5), ("T0R", 199.0, 233.5),
                ("T1L", 93.0, 392.0), ("T1R", 199.0, 392.0),
                ("T2L", 93.0, 537.0), ("T2R", 199.0, 537.0)],
        rounds=[],
        rounds_forced=[(93.0, 47.0), (199.0, 47.0), (93.0, 143.0), (199.0, 143.0), (146.0, 95.0)],
        ...
        flip_minutes=0,
        notes=[
            'The Four On Top pattern (straight 2x3 grid + the five-round quincunx) with the whole ensemble slid 12 inches west - the east service lane widens.',
    ...
    dict(
        ...
        rot90=False,
        tables=[("T0L", 95.0, 233.5), ("T0R", 221.0, 233.5),
                ("T1L", 95.0, 392.0), ("T1R", 221.0, 392.0),
                ("T2L", 95.0, 537.0), ("T2R", 221.0, 537.0)],
        rounds=[],
        rounds_forced=[(95.0, 47.0), (221.0, 47.0), (95.0, 143.0), (221.0, 143.0), (158.0, 95.0)],
        rounds_plus=[(158.0, 95.0)],
        round_role="flex",
        pack_grid=False,
        twotops=TWOTOPS_2X3,
        ...
        flip_minutes=0,
        notes=[
            'The Four On Top pattern (straight 2x3 grid + the five-round quincunx) with the whole ensemble columns spread apart - a wide center promenade.',
            'Wall two-tops stay put on their walls; the grid and rounds move together, so every table keeps a two-top within reach.',
            'FLAG: The center round of the north quincunx runs tight to its four neighbours - deliberate, as in the base layout.',
            'The center aisle grows from 52 to 72 inches - a shared promenade both columns play and serve from.',
        ],
    ),
    dict(
        key="gridbal",
    ...
    dict(
        key="centershift",
        name="K · Center Line — Shifted Down",
        letter="K",
        short="center 1×6 low",
        tagline="The center line slid down-wall; the entry end opens up",
        rot90=True,
        lane_x=241.0,
        aisle_x=65.0,
        tables=[("Line0", 158.0, 37.5), ("Line1", 158.0, 138.5), ("Line2", 158.0, 239.5), ("Line3", 158.0, 340.5), ("Line4", 158.0, 441.5), ("Line5", 158.0, 542.5)],
        rounds=[],
        round_role="flex",
        twotops=[],
        twotop_role=None,
        hightops=[(25, 64.2), (25, 165.2), (25, 266.2), (25, 367.2), (25, 468.2), (25, 556.5),
                  (291, 64.2), (291, 165.2), (291, 231.5), (291, 376.5), (291, 468.2), (291, 554.5)],
        rails=[],
        bench=False, bench_role=None,
        classroom=False, bleachers=[], stage_seats=0,
        flip_minutes=0,
        notes=[
            'The Center Line slid down-wall (v56 low): the whole file slides about 33 inches toward the north wall, freeing the entry end so the south approach opens up.',
            'Six tables end-to-end down the middle; wall drink rails flank both sides, staff work the two side aisles.',
            'FLAG: the rotated ends run tight side-to-side — the side aisles are the practical maximum, not the cue standard.',
        ],
    ),
    dict(
        key="turnright",
        name="L · Four On Top — Turned Right",
        letter="L", short="right 4+2",
    ...
    dict(
        key="eastline",
        name="M · East Line + West Lounge",
        letter="M", short="east 1×6",
    ...
    dict(
        key="eastshift",
        name="N · East Line — Shifted Down",
        letter="N", short="east 1×6 low",
