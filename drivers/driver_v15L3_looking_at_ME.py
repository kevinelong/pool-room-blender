...
cd = bpy.data.cameras.new("CAM_v15L3_looking_at_ME")
cd.type = 'PERSP'
cd.lens = 14.0                 # slight wide to include some flanking room
cd.clip_end = 400.0
co = bpy.data.objects.new("CAM_v15L3_looking_at_ME", cd)
...
out = os.path.join(HERE, "render_v15L3_persp_west_to_ME.png")
